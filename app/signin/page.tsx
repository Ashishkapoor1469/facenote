...
export default function SignupPage() {
  ...
  return (
    <div className="font-display min-h-screen flex flex-col items-center justify-center bg-background-light dark:bg-background-dark relative overflow-hidden">
      {/* Background Blurs */}
      <div className="absolute inset-0 z-0">
        <div className="absolute bottom-0 left-[-20%] right-0 top-[-10%] h-[500px] w-[500px] rounded-full bg-[#E0F7FA]/50 opacity-50 blur-[120px] dark:bg-[#308ce8]/20" />
        <div className="absolute right-[-20%] top-[-20%] h-[500px] w-[500px] rounded-full bg-[#E1D5E7]/50 opacity-50 blur-[120px] dark:bg-[#308ce8]/20" />
        <div className="absolute bottom-[-10%] left-[20%] h-[500px] w-[500px] rounded-full bg-[#FFE4E1]/50 opacity-50 blur-[120px] dark:bg-[#308ce8]/20" />
      </div>

      {/* Signup Card */}
      <main className="relative z-10 w-full lg:w-8/12 p-4 sm:p-6 md:p-8">
        <div className="glass-effect rounded-xl p-6 sm:p-8">
          <div className="flex flex-col items-center gap-6">
            ...
            {/* Signup Form */}
            <div className="w-full space-y-4 md:gap-2.5 grid md:grid-cols-2">
              ...
              {/* Sign Up Button */}
              <button className="w-full md:mt-7 rounded-lg bg-primary h-12 border text-base font-semibold text-white transition-all hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 dark:focus:ring-offset-background-dark">
                Sign Up
              </button>
            </div>
